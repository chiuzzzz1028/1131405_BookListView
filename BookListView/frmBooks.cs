...
namespace BookListView
{
    public partial class frmBooks : Form
    {
        ...
        {
            if (lstBorrow.Items.Count == 0)
            {
                MessageBox.Show("借書清單已是空的！");
                return;
            }
        ...
        {
            var result = MessageBox.Show("確定要離開嗎？", "離開確認", MessageBoxButtons.YesNo);
